...
import {GlitchyComics} from "../GlitchyComics/GlitchyComics";
import {APIWrapper, Source} from "paperback-extensions-common";

describe("GlitchyComics Tests", function () {
    let wrapper: APIWrapper = new APIWrapper();
    let source: Source = new GlitchyComics(cheerio);
    let chai = require("chai"),
        expect = chai.expect;
    let chaiAsPromised = require("chai-as-promised");
    chai.use(chaiAsPromised);

    let mangaId = "forced-to-become-the-villains-son-in-law";
